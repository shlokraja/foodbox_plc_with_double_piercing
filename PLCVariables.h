    ...
    //TATA Machine Testing
    #define d1stringPlaceOrderbarcode "Disp_New_Order_order_barcode"
    #define d1MLstringPlaceOrderbarcode "ST9:12.LEN"  // MicroLogix

    #define d1stringPlaceOrderdetails "Disp_New_Order_second_part"
    #define d1MLstringPlaceOrderdetails "ST9:13.LEN"  // MicroLogix
